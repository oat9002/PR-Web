...
const welfare = (props) => {
    return (
        <ReponsiveContainer>
            <Header as='h2' style={{ padding: '1em' }} content='สวัสดิ์การ' />
            <ul>
            	...
            	<li><a href = '//drive.google.com/file/d/1JMY_OI_FE530ZFZEOJM1NE2m4vKE15GC/view?usp=sharing'>สิทธิการลาดประเภทต่าง ๆ-การลา</a></li><br />
           </ul>
        </ReponsiveContainer>
    );
}
